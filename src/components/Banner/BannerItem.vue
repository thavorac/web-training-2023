...
import CreateFormBanner from './CreateFormBanner.vue'; // Import the CreateFormCategory component
    ...
    <CategoryView :subtitle="'Banner'">
        <div class="w-full selection:bg-gray-100 py-10 px-10 mt-10 rounded-lg bg-gray-200 shadow-md">
            <div class="w-full bg-white rounded-md p-2">
                    ...
                    <div class="flex">
                        <div class="bg-gray-100 flex items-center py-3 px-3 space-x-4 rounded-md">
                            ...
                            <button @click="toggleCreateForm"
                                ...
                                <span class="text-xl font-semibold">Banner</span>
                            </button>
                        </div>
                    </div>
                ...
                <template v-else>
                    <CreateFormBanner @cancel="handleCancel" /> <!-- Listen for cancel event -->
                </template>
            </div>
