<template>
    ...
    <div class="container-fluid container">
        <div class="logo">
            <div class="icon" style="width: 300px; height: 20px;">
                <img src="../assets/image/Logo.png" alt="">
            </div>
            <div class="name pt-2">
                <RouterLink class=" no-underline text-slate-900" to="/">
                    Luminae
                </RouterLink>
            </div>
        ...
        <div class="menuList pt-2">
            ...
            <a class="text-decoration-none" href="#">Help&support</a>
        </div>
        <div class="social">
            <div class="item">
                <span class="instagram"><img src="../assets/image/Instagram.png" alt=""></span>
                <span class="fb"><img src="../assets/image/FB.png" alt=""></span>
                <span class="telegram"><img src="../assets/image/Telegram.png" alt=""></span>
            </div>
...
.container .searchIcon .inside .categories select,
option {
    width: 108px;
    height: 20px;
    font-size: 14px;
