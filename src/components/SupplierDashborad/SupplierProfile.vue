...
<template>
  <ProductView :subtitle="'Supplier Profile'">
      ...
      <div class="w-full bg-white rounded-md p-2">
                    ...
                    <div class="card">
                      <div class="card-body">
                        <div class="d-flex flex-column align-items-center text-center">
                          <img src="../../assets/image/profile.avif" alt="Supplier"
                            class="rounded-circle p-1 bg-primary" width="170">
                          <div class="mt-3 pl-2">
                            <h4>{{ supplier.name }}</h4>
                            <ul class="list-unstyled mb-4 pl-5">
                              <li class="mb-3 text-start"><i
                                  class="far fa-envelope display-25 me-3 text-secondary"></i>{{ supplier.email }}</li>
                              <li class="mb-3 text-start"><i
                                  class="fas fa-mobile-alt display-25 me-3 text-secondary"></i>{{ supplier.phone }}</li>
                              <li class="text-start"><i
                                  class="fas fa-map-marker-alt display-25 me-3 text-secondary"></i>{{ supplier.address
                                }}</li>
                            </ul>
                          </div>
                        </div>
                  ...
                  <div class="col-lg-8">
                    <div class="card">
                      ...
                      <div class="row pl-5 pb-3">
                        <div class="col-sm-2">
                          <router-link to="/supplier" class="mr-2">
        ...
        <template v-else>
          <div class="alert alert-warning" role="alert">
            No supplier profile found. Please log in as an supplier.
          </div>
        </template>
      </div>
    </div>
